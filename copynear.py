...
class CopynearCommand(sublime_plugin.WindowCommand):
    ...
    def run(self):
        ...
        self.window.show_input_panel("Copy:", newPath, lambda user_input: self.rename(view, filename, user_input), None, None)
